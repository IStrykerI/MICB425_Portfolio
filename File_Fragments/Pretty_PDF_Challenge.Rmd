...
![](File_Fragments/Images/A3_Comic.png)

[http://phdcomics.com/](http://phdcomics.com/) Comic posted 
`r substr(format(Sys.Date(), '%m-%d-%Y'), regexpr("[^0]", format(Sys.Date(), '%m-%d-%Y')), nchar(format(Sys.Date(), '%m-%d-%Y')))`
...
![](File_Fragments/Images/Husky.gif)
