...
- For final tree outputs from Project 2, please refer to the folder in File_Fragments/final_trees for both DNA and RNA trees
...
```{r, echo=FALSE}
htmltools::tags$iframe(title="MICB425 Project 1", src="File_Fragments/Project1/main.html", height=1000, width=1000)
```
...
#### Editing  
Edited both the draft and final copy  
...
### Methods  
#### Writing  
Wrote all parts of Method except General Linear Model  
...
### Results  
#### Anaysis  
Analyzed the overall trend of data from both Mothur and QIIME2  

#### Figures  
N/A  

#### Writing  
Wrote the last paragraph (Analysis of results from Mothur and QIIME2 processed data)  
...
### Discussion  
#### Literature research  
Did literature searches only for the 4 points  

#### Writing  
Wrote the 4 major points and future directions  
...
```{r, echo=FALSE}
htmltools::tags$iframe(title="MICB425 Project 2", src="File_Fragments/Project2/main.html", height=1000, width=1000)
```
...
### Methods  
#### Writing  
Wrote all the Methods (TreeSAPP/RPKM/etc.)  
...
#### Figures  
Edited some figures (Contributed by Abdur) to match feedbacks from first draft  
...
### Discussion  
#### Literature research  
Provided literature sources to support Discussion  

#### Writing  
Wrote Point 2 of Discussion (Propose evolutionary, environmental, etc. reasoning for distributed metabolism as seen in the nitrogen cycle)  
